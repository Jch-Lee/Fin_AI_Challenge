...
# -*- coding: utf-8 -*-
"""
RAG v2.0 Final Submission Generator - Corrected Version
test_rag_inference_qwen_final.py와 완전히 동일한 파이프라인 사용
"""
...
def main():
    """메인 함수"""
    logger.info("="*60)
    logger.info("RAG v2.0 Final Submission Generation (Corrected)")
    logger.info("="*60)
    ...
    # 결과 저장
    output_file = f"submission_rag_v2_enhanced_mc_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
