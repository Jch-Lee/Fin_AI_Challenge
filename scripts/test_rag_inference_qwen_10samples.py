...
# -*- coding: utf-8 -*-
"""
RAG v2.0을 활용한 10개 샘플 추론 테스트 - Qwen2.5-7B-Instruct 버전
원격 서버용 스크립트
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('rag_inference_qwen_10samples.log'),
...
def create_prompt_with_context(question: str, context: str) -> str:
    ...
    system_prompt = "당신은 금융 보안 전문가입니다. 제공된 참고 자료를 바탕으로 정확하고 전문적인 답변을 제공하세요."
...
def main():
    """메인 함수"""
    logger.info("="*60)
    logger.info("RAG v2.0 Inference Test - 10 Samples (Qwen2.5-7B-Instruct)")
    logger.info("="*60)
    ...
    # 결과 저장
    output_file = "rag_v2_qwen_test_10samples.csv"
